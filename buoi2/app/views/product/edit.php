...
<?php endif; ?>
<form method="POST" action="/buoi2/Product/update" enctype="multipart/form-data" onsubmit="return validateForm();">
...
<a href="/buoi2/Product/" class="btn btn-secondary mt-2">Quay lại danh sách
    sản phẩm</a>
